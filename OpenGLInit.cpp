...
/*   Updated: 2019/07/12 18:09:36 by dpeck            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool OpenGLInit::createWindow()
{
	...
	ResourceManager::loadCamera("main", glm::vec3(0.0f, 0.0f, 5.0f));
...
bool OpenGLInit::buildShaders()
{
    ...
    shader = &ResourceManager::loadShader("./shaders/modelLoading.shader", "modelLoadingShader");
	glm::mat4 model(1.0f);
...
{
    ResourceManager::loadTexture("./textures/snake-graphics.png", "snake");
    ResourceManager::loadTexture("./textures/grass.png", "grass");
    ResourceManager::loadTexture("./textures/tree.png", "tree");    
}